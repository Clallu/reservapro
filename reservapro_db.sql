...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2025 a las 15:53:01
...
--
ALTER TABLE `historial_reservas`
  ADD CONSTRAINT `historial_reservas_ibfk_1` FOREIGN KEY (`reserva_id`) REFERENCES `reservas` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `reservas`
  ...
  ADD CONSTRAINT `reservas_ibfk_2` FOREIGN KEY (`mesa_id`) REFERENCES `mesas` (`id`) ON DELETE CASCADE;
COMMIT;
